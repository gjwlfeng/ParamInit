...
public class ActivityBundleParamBindingBundleHolder extends ActivityBundleParamBindingHolder {

    private ActivityBundleParamBindingBundleHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityBundleParamBindingBundleHolder> {
        ...
        public ActivityBundleParamBindingBundleHolder getHolder() {
            return new ActivityBundleParamBindingBundleHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
