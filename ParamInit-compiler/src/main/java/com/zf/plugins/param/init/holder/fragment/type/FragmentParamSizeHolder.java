...
public class FragmentParamSizeHolder extends FragmentParamBinderHolder {

    private FragmentParamSizeHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
        ...
        if (param.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    ...
                    builder.addStatement("fragment.$N =($T)$N.getSize($L)",
                            getOriginFiledName(),
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (param.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("savedInstanceState.putSize($L,fragment.$N)",
                            getParamFiledName(),
                            getOriginFiledName());
                    return false;
                }
    ...
    public static class CreationHolder extends FragmentCreationHolder<FragmentParamSizeHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public FragmentParamSizeHolder getHolder() {
            return new FragmentParamSizeHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
