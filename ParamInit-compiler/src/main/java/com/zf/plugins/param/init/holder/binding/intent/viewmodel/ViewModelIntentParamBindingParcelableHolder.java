...
public class ViewModelIntentParamBindingParcelableHolder extends ViewModelIntentParamBindingHolder {

    private ViewModelIntentParamBindingParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public boolean onGetValue(MethodSpec.Builder methodSpec) {
        ...
        methodSpec.addStatement("return intent.getParcelableExtra($N)", getParamFiledName());
        methodSpec.returns(typeName);
        return true;

    }

    public static class CreationHolder extends ViewModelCreationHolder<ViewModelIntentParamBindingParcelableHolder> {
        ...
        public ViewModelIntentParamBindingParcelableHolder getHolder() {
            return new ViewModelIntentParamBindingParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
