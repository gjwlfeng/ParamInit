 ...
 * 包装类
 */
public class ActivityBundleParamBindingStringHolder extends ActivityBundleParamBindingHolder {

    private ActivityBundleParamBindingStringHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityBundleParamBindingStringHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv,element,isSupportV4,isAndroidX);
        }

        public ActivityBundleParamBindingStringHolder getHolder() {
            return new ActivityBundleParamBindingStringHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
