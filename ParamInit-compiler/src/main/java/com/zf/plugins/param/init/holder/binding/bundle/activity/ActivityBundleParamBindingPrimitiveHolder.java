...
public class ActivityBundleParamBindingPrimitiveHolder extends ActivityBundleParamBindingHolder {

    private ActivityBundleParamBindingPrimitiveHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityBundleParamBindingPrimitiveHolder> {
        ...
        public ActivityBundleParamBindingPrimitiveHolder getHolder() {
            return new ActivityBundleParamBindingPrimitiveHolder(this.annotationEnv, this.element,isSupportV4,isAndroidX);
        }
    }
}
