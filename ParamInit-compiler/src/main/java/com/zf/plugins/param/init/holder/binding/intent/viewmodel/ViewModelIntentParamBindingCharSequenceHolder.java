...
public class ViewModelIntentParamBindingCharSequenceHolder extends ViewModelIntentParamBindingHolder {

    private ViewModelIntentParamBindingCharSequenceHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelIntentParamBindingCharSequenceHolder> {
        ...
        public ViewModelIntentParamBindingCharSequenceHolder getHolder() {
            return new ViewModelIntentParamBindingCharSequenceHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
