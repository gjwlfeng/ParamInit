...
public class ViewModelIntentParamBindingSerializableHolder extends ViewModelIntentParamBindingHolder {

    private ViewModelIntentParamBindingSerializableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public boolean onGetValue(MethodSpec.Builder methodSpec) {
        ...
        methodSpec.addStatement("$T obj = intent.getSerializableExtra($N)", ClassName.OBJECT, getParamFiledName());
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelIntentParamBindingSerializableHolder> {
        ...
        public ViewModelIntentParamBindingSerializableHolder getHolder() {
...
//            }
            ...
            return new ViewModelIntentParamBindingSerializableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
