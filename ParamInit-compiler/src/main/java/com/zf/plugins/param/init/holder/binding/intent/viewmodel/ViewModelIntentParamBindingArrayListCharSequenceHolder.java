...
public class ViewModelIntentParamBindingArrayListCharSequenceHolder extends ViewModelIntentParamBindingHolder {

    private ViewModelIntentParamBindingArrayListCharSequenceHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelIntentParamBindingArrayListCharSequenceHolder> {
        ...
        public ViewModelIntentParamBindingArrayListCharSequenceHolder getHolder() {
            return new ViewModelIntentParamBindingArrayListCharSequenceHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
