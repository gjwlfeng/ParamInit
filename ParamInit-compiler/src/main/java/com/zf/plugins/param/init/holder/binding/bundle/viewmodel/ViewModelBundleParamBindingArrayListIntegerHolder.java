 ...
 * 包装类
 */
public class ViewModelBundleParamBindingArrayListIntegerHolder extends ViewModelBundleParamBindingHolder {

    private ViewModelBundleParamBindingArrayListIntegerHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelBundleParamBindingArrayListIntegerHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public ViewModelBundleParamBindingArrayListIntegerHolder getHolder() {
            return new ViewModelBundleParamBindingArrayListIntegerHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
