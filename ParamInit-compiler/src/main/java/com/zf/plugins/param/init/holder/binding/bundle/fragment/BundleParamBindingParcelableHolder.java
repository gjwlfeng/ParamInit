...
public class BundleParamBindingParcelableHolder extends FragmentBundleParamBindingHolder {

    private BundleParamBindingParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends FragmentCreationHolder<BundleParamBindingParcelableHolder> {
        ...
        public BundleParamBindingParcelableHolder getHolder() {
            return new BundleParamBindingParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
