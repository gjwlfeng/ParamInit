...
public class FragmentParamArrayListIntegerHolder extends FragmentParamHolder {

    private FragmentParamArrayListIntegerHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("fragment.$N =$N.getIntegerArrayList($L)",
                            getOriginFiledName(),
                            globalVarName,
                            getParamFiledName());
                    return false;
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInit.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("savedInstanceState.putIntegerArrayList($L,fragment.$N)",
                            getParamFiledName(),
                            getOriginFiledName());
    ...
    public static class CreationHolder extends FragmentCreationHolder<FragmentParamArrayListIntegerHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element,boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public FragmentParamArrayListIntegerHolder getHolder() {


            return new FragmentParamArrayListIntegerHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
