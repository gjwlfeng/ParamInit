...
public class ActivityParamArrayListParcelableHolder extends ActivityParamHolder {

    private ActivityParamArrayListParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("activity.$N = $N.getParcelableArrayList($L)",
                            getOriginFiledName(),
                            globalVarName,
                            getParamFiledName());
                    return false;
    ...
    public void onInitMethodWithIntent(MethodSpec.Builder methodSpec, String globalVarName) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("activity.$N = $N.getParcelableArrayListExtra($L)",
                            getOriginFiledName(),
                            globalVarName,
                            getParamFiledName());
                    return false;
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInit.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("savedInstanceState.putParcelableArrayList($L,activity.$N)",
                            getParamFiledName(),
                            getOriginFiledName());
                    return false;
                }
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityParamArrayListParcelableHolder> {
        ...
        public ActivityParamArrayListParcelableHolder getHolder() {
            return new ActivityParamArrayListParcelableHolder(this.annotationEnv, this.element,isSupportV4,isAndroidX);
        }
    }
}
