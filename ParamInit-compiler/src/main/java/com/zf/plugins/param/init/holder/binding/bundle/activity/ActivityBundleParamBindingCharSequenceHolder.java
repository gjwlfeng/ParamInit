...
public class ActivityBundleParamBindingCharSequenceHolder extends ActivityBundleParamBindingHolder {

    private ActivityBundleParamBindingCharSequenceHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityBundleParamBindingCharSequenceHolder> {
        ...
        public ActivityBundleParamBindingCharSequenceHolder getHolder() {
            return new ActivityBundleParamBindingCharSequenceHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
