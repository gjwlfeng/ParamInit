...
public class ActivityIntentParamBindingStringHolder extends ActivityIntentParamBindingHolder {

    private ActivityIntentParamBindingStringHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityIntentParamBindingStringHolder> {
        ...
        public ActivityIntentParamBindingStringHolder getHolder() {
            return new ActivityIntentParamBindingStringHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
