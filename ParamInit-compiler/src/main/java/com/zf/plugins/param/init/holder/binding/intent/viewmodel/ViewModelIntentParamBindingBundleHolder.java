...
public class ViewModelIntentParamBindingBundleHolder extends ViewModelIntentParamBindingHolder {

    private ViewModelIntentParamBindingBundleHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public boolean onGetValue(MethodSpec.Builder methodSpec) {
        ...
        methodSpec.addStatement("return intent.getBundleExtra($N)", getParamFiledName());
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelIntentParamBindingBundleHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public ViewModelIntentParamBindingBundleHolder getHolder() {
            return new ViewModelIntentParamBindingBundleHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
