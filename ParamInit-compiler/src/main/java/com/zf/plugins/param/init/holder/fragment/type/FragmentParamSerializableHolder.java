...
public class FragmentParamSerializableHolder extends FragmentParamHolder {

    private FragmentParamSerializableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInject.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    ...
                    builder.addStatement("fragment.$N = ($T)$N.getSerializable($L)",
                            getOriginFiledName(),
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInject.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("savedInstanceState.putSerializable($L,fragment.$N)",
                            getParamFiledName(),
                            getOriginFiledName());
                    return false;
                }
    ...
    public static class CreationHolder extends FragmentCreationHolder<FragmentParamSerializableHolder> {
        ...
        public FragmentParamSerializableHolder getHolder() {
            return new FragmentParamSerializableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
