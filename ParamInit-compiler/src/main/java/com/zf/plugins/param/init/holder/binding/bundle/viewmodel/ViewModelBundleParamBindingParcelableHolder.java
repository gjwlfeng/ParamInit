...
public class ViewModelBundleParamBindingParcelableHolder extends ViewModelBundleParamBindingHolder {

    private ViewModelBundleParamBindingParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelBundleParamBindingParcelableHolder> {
        ...
        public ViewModelBundleParamBindingParcelableHolder getHolder() {
            return new ViewModelBundleParamBindingParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
