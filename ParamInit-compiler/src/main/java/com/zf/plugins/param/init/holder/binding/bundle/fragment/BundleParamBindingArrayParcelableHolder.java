...
public class BundleParamBindingArrayParcelableHolder extends FragmentBundleParamBindingHolder {

    private BundleParamBindingArrayParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends FragmentCreationHolder<BundleParamBindingArrayParcelableHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv,element,isSupportV4,isAndroidX);
        }

        public BundleParamBindingArrayParcelableHolder getHolder() {
            return new BundleParamBindingArrayParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
