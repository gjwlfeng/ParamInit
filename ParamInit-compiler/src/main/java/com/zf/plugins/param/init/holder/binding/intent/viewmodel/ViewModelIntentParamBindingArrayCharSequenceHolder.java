...
public class ViewModelIntentParamBindingArrayCharSequenceHolder extends ViewModelIntentParamBindingHolder {

    private ViewModelIntentParamBindingArrayCharSequenceHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelIntentParamBindingArrayCharSequenceHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public ViewModelIntentParamBindingArrayCharSequenceHolder getHolder() {
            return new ViewModelIntentParamBindingArrayCharSequenceHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
