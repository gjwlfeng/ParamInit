 ...
 * 包装类
 */
public class ViewModelIntentParamBindingArrayListStringHolder extends ViewModelIntentParamBindingHolder {

    private ViewModelIntentParamBindingArrayListStringHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelIntentParamBindingArrayListStringHolder> {
        ...
        public ViewModelIntentParamBindingArrayListStringHolder getHolder() {
            return new ViewModelIntentParamBindingArrayListStringHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
