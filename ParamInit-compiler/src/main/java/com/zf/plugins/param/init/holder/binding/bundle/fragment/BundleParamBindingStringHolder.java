 ...
 * 包装类
 */
public class BundleParamBindingStringHolder extends FragmentBundleParamBindingHolder {

    private BundleParamBindingStringHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends FragmentCreationHolder<BundleParamBindingStringHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv,element,isSupportV4,isAndroidX);
        }

        public BundleParamBindingStringHolder getHolder() {
            return new BundleParamBindingStringHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
