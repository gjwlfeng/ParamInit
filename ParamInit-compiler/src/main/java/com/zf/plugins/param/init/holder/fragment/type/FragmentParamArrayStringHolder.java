...
public class FragmentParamArrayStringHolder extends FragmentParamArrayHolder {

    private FragmentParamArrayStringHolder(AnnotationEnv annotationEnv, Element element,boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    ...
                    builder.addStatement("fragment.$N =$N.getStringArray($L)",
                            getOriginFiledName(),
                            globalVarName,
                            getParamFiledName());
                    return false;
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInit.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("savedInstanceState.putStringArray($L,fragment.$N)",
                            getParamFiledName(),
                            getOriginFiledName());
    ...
    public static class CreationHolder extends FragmentCreationHolder<FragmentParamArrayStringHolder> {
        ...
        public FragmentParamArrayStringHolder getHolder() {


            return new FragmentParamArrayStringHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
