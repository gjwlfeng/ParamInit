 ...
 * 包装类
 */
public class BundleParamBindingArrayListStringHolder extends FragmentBundleParamBindingHolder {

    private BundleParamBindingArrayListStringHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends FragmentCreationHolder<BundleParamBindingArrayListStringHolder> {
        ...
        public BundleParamBindingArrayListStringHolder getHolder() {
            return new BundleParamBindingArrayListStringHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
