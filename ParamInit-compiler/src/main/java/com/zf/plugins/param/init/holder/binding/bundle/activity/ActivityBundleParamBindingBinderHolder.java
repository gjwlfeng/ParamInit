 ...
 * 包装类
 */
public class ActivityBundleParamBindingBinderHolder extends ActivityBundleParamBindingHolder {

    private ActivityBundleParamBindingBinderHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityBundleParamBindingBinderHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv,element,isSupportV4,isAndroidX);
        }

        public ActivityBundleParamBindingBinderHolder getHolder() {
            return new ActivityBundleParamBindingBinderHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
