...
public class ActivityBundleParamBindingArrayListParcelableHolder extends ActivityBundleParamBindingHolder {

    private ActivityBundleParamBindingArrayListParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityBundleParamBindingArrayListParcelableHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv,element,isSupportV4,isAndroidX);
        }

        public ActivityBundleParamBindingArrayListParcelableHolder getHolder() {
            return new ActivityBundleParamBindingArrayListParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
