...
public class FragmentParamArrayCharSequenceHolder extends FragmentParamArrayHolder {

    private FragmentParamArrayCharSequenceHolder(AnnotationEnv annotationEnv, Element element,boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    ...
                    builder.addStatement("fragment.$N =($T) $N.getCharSequenceArray($L)",
                            getOriginFiledName(),
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInit.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("savedInstanceState.putCharSequenceArray($L,fragment.$N)",
                            getParamFiledName(),
                            getOriginFiledName());
    ...
    public static class CreationHolder extends FragmentCreationHolder<FragmentParamArrayCharSequenceHolder> {
        ...
        public FragmentParamArrayCharSequenceHolder getHolder() {

            return new FragmentParamArrayCharSequenceHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
