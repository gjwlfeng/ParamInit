 ...
 * 包装类
 */
public class BundleParamBindingSizeFHolder extends FragmentBundleParamBindingHolder {

    private BundleParamBindingSizeFHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends FragmentCreationHolder<BundleParamBindingSizeFHolder> {
        ...
        public BundleParamBindingSizeFHolder getHolder() {
            return new BundleParamBindingSizeFHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
