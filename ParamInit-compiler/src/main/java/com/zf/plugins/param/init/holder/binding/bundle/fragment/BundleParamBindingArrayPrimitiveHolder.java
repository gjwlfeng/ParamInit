...
public class BundleParamBindingArrayPrimitiveHolder extends FragmentBundleParamBindingHolder {

    private BundleParamBindingArrayPrimitiveHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends FragmentCreationHolder<BundleParamBindingArrayPrimitiveHolder> {
        ...
        public BundleParamBindingArrayPrimitiveHolder getHolder() {
            return new BundleParamBindingArrayPrimitiveHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
