 ...
 * 包装类
 */
public class ViewModelBundleParamBindingBinderHolder extends ViewModelBundleParamBindingHolder {

    private ViewModelBundleParamBindingBinderHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelBundleParamBindingBinderHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public ViewModelBundleParamBindingBinderHolder getHolder() {
            return new ViewModelBundleParamBindingBinderHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
