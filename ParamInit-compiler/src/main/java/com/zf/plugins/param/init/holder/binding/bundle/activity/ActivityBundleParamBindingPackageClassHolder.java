...
public class ActivityBundleParamBindingPackageClassHolder extends ActivityBundleParamBindingHolder {

    private ActivityBundleParamBindingPackageClassHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityBundleParamBindingPackageClassHolder> {
        ...
        public ActivityBundleParamBindingPackageClassHolder getHolder() {
            return new ActivityBundleParamBindingPackageClassHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
