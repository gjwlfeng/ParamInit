...
import com.zf.plugins.param.init.holder.activity.ActivityParamSparseArrayHolder;
 ...
 * 包装类
 */
public class ActivityParamSparseArrayParcelableHolder extends ActivityParamSparseArrayHolder {

    private ActivityParamSparseArrayParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("activity.$N = $N.getSparseParcelableArray($L)",
                            getOriginFiledName(),
                            globalVarName,
                            getParamFiledName());
                    return false;
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInit.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    methodSpec.addStatement("savedInstanceState.putSparseParcelableArray($L,activity.$N)", getParamFiledName(), getOriginFiledName());
                    return false;
                }
            });
            methodSpec.endControlFlow();
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityParamSparseArrayParcelableHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public ActivityParamSparseArrayParcelableHolder getHolder() {
            return new ActivityParamSparseArrayParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
