 ...
 * 包装类
 */
public class ViewModelBundleParamBindingArrayListStringHolder extends ViewModelBundleParamBindingHolder {

    private ViewModelBundleParamBindingArrayListStringHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelBundleParamBindingArrayListStringHolder> {
        ...
        public ViewModelBundleParamBindingArrayListStringHolder getHolder() {
            return new ViewModelBundleParamBindingArrayListStringHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
