...
public class ActivityIntentParamBindingArrayStringHolder extends ActivityIntentParamBindingHolder {

    private ActivityIntentParamBindingArrayStringHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public boolean onGetValue(MethodSpec.Builder methodSpec) {
        ...
        methodSpec.addStatement("$T obj = intent.getStringArrayExtra($N)", ClassName.OBJECT, getParamFiledName());
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityIntentParamBindingArrayStringHolder> {
        ...
        public ActivityIntentParamBindingArrayStringHolder getHolder() {
            return new ActivityIntentParamBindingArrayStringHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
