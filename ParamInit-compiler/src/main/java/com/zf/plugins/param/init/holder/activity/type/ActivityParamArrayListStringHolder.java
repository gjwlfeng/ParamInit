 ...
 * 包装类
 */
public class ActivityParamArrayListStringHolder extends ActivityParamHolder {

    private ActivityParamArrayListStringHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("activity.$N = $N.getStringArrayList($L)",
                            getOriginFiledName(),
                            globalVarName,
                            getParamFiledName());
                    return false;
    ...
    public void onInitMethodWithIntent(MethodSpec.Builder methodSpec, String globalVarName) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("activity.$N = $N.getStringArrayListExtra($L)",
                            getOriginFiledName(),
                            globalVarName,
                            getParamFiledName());
                    return false;
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInit.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    methodSpec.addStatement("savedInstanceState.putStringArrayList($L,activity.$N)", getParamFiledName(), getOriginFiledName());
                    return false;
                }
            });
            methodSpec.endControlFlow();
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityParamArrayListStringHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element,boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element,isSupportV4,isAndroidX);
        }

        public ActivityParamArrayListStringHolder getHolder() {
            return new ActivityParamArrayListStringHolder(this.annotationEnv, this.element,isSupportV4,isAndroidX);
        }
    }
}
