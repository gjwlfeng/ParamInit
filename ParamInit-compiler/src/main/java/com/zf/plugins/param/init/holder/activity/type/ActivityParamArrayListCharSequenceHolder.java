...
public class ActivityParamArrayListCharSequenceHolder extends ActivityParamHolder {

    private ActivityParamArrayListCharSequenceHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    ...
                    builder.addStatement("activity.$N = ($T)$N.getCharSequenceArrayList($L)",
                            getOriginFiledName(),
    ...
    public void onInitMethodWithIntent(MethodSpec.Builder methodSpec, String globalVarName) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    TypeMirror typeMirror = element.asType();
                    builder.addStatement("activity.$N = ($T)$N.getCharSequenceArrayListExtra($L)",
                            getOriginFiledName(),
                            ClassName.get(typeMirror),
                            globalVarName,
                            getParamFiledName());
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInit.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("savedInstanceState.putCharSequenceArrayList($L,activity.$N)", getParamFiledName(), getOriginFiledName());
                    return false;
                }
            });
            methodSpec.endControlFlow();
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityParamArrayListCharSequenceHolder> {
        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        @Override
        public ActivityParamArrayListCharSequenceHolder getHolder() {
            return new ActivityParamArrayListCharSequenceHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
