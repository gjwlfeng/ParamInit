...
public class ActivityIntentParamBindingArrayParcelableHolder extends ActivityIntentParamBindingHolder {

    private ActivityIntentParamBindingArrayParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityIntentParamBindingArrayParcelableHolder> {
        ...
        public ActivityIntentParamBindingArrayParcelableHolder getHolder() {
            return new ActivityIntentParamBindingArrayParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
