...
public class ViewModelBundleParamBindingArrayStringHolder extends ViewModelBundleParamBindingHolder {

    private ViewModelBundleParamBindingArrayStringHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelBundleParamBindingArrayStringHolder> {
        ...
        public ViewModelBundleParamBindingArrayStringHolder getHolder() {
            return new ViewModelBundleParamBindingArrayStringHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
