...
public class ActivityParamSizeHolder extends ActivityParamArrayHolder {

    private ActivityParamSizeHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    ...
                    builder.addStatement("activity.$N =$N.getSize($L)",
                            getOriginFiledName(),
                            globalVarName,
                            getParamFiledName());
                    return false;
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInit.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("savedInstanceState.putSize($L,activity.$N)", getParamFiledName(), getOriginFiledName());
                    return false;
                }
            });
            methodSpec.endControlFlow();
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityParamSizeHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public ActivityParamSizeHolder getHolder() {
            return new ActivityParamSizeHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
