...
public class ActivityIntentParamBindingBundleHolder extends ActivityIntentParamBindingHolder {

    private ActivityIntentParamBindingBundleHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityIntentParamBindingBundleHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public ActivityIntentParamBindingBundleHolder getHolder() {
            return new ActivityIntentParamBindingBundleHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
