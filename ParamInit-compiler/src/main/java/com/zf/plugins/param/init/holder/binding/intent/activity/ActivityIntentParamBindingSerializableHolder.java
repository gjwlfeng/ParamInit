...
public class ActivityIntentParamBindingSerializableHolder extends ActivityIntentParamBindingHolder {

    private ActivityIntentParamBindingSerializableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityIntentParamBindingSerializableHolder> {
        ...
        public ActivityIntentParamBindingSerializableHolder getHolder() {
            return new ActivityIntentParamBindingSerializableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
