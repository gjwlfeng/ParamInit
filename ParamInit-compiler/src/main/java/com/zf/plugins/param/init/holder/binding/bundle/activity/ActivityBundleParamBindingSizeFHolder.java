 ...
 * 包装类
 */
public class ActivityBundleParamBindingSizeFHolder extends ActivityBundleParamBindingHolder {

    private ActivityBundleParamBindingSizeFHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ActivityCreationHolder<ActivityBundleParamBindingSizeFHolder> {
        ...
        public ActivityBundleParamBindingSizeFHolder getHolder() {
            return new ActivityBundleParamBindingSizeFHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
