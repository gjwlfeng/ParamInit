...
public class BundleParamBindingCharSequenceHolder extends FragmentBundleParamBindingHolder {

    private BundleParamBindingCharSequenceHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends FragmentCreationHolder<BundleParamBindingCharSequenceHolder> {
        ...
        public BundleParamBindingCharSequenceHolder getHolder() {
            return new BundleParamBindingCharSequenceHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
