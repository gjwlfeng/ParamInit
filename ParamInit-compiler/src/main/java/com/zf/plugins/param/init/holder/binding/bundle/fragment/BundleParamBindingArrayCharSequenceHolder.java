...
public class BundleParamBindingArrayCharSequenceHolder extends FragmentBundleParamBindingHolder {

    private BundleParamBindingArrayCharSequenceHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends FragmentCreationHolder<BundleParamBindingArrayCharSequenceHolder> {
        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public BundleParamBindingArrayCharSequenceHolder getHolder() {
            return new BundleParamBindingArrayCharSequenceHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
