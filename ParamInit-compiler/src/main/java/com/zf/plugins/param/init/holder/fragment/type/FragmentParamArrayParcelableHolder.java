...
public class FragmentParamArrayParcelableHolder extends FragmentParamArrayHolder {

    private FragmentParamArrayParcelableHolder(AnnotationEnv annotationEnv, Element element,boolean isSupportV4, boolean isAndroidX) {
        ...
        if (paramInit.inject()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                ...
                public boolean innerBlock(MethodSpec.Builder builder) {
                    ...
                    builder.addStatement("fragment.$N =($T) $N.getParcelableArray($L)",
                            getOriginFiledName(),
    ...
    public void onSaveStateMethod(MethodSpec.Builder methodSpec) {
        ...
        if (paramInit.persistence()) {
            ...
            MethodSpecUtils.codeBlock(methodSpec, new MethodSpecBuilderCallBack() {
                @Override
                public boolean innerBlock(MethodSpec.Builder builder) {
                    builder.addStatement("savedInstanceState.putParcelableArray($L,fragment.$N)",
                            getParamFiledName(),
                            getOriginFiledName());
    ...
    public static class CreationHolder extends FragmentCreationHolder<FragmentParamArrayParcelableHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element,boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element,isSupportV4,isAndroidX);
        }

        public FragmentParamArrayParcelableHolder getHolder() {

            return new FragmentParamArrayParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
