...
public class ViewModelBundleParamBindingArrayParcelableHolder extends ViewModelBundleParamBindingHolder {

    private ViewModelBundleParamBindingArrayParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public boolean onGetValue(MethodSpec.Builder methodSpec) {
        ...
        methodSpec.addStatement("return bundle.getParcelableArray($N)", getParamFiledName());
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelBundleParamBindingArrayParcelableHolder> {

        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public ViewModelBundleParamBindingArrayParcelableHolder getHolder() {
            return new ViewModelBundleParamBindingArrayParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
