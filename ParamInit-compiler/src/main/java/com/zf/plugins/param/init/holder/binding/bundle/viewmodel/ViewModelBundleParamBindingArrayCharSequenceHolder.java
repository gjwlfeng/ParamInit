...
public class ViewModelBundleParamBindingArrayCharSequenceHolder extends ViewModelBundleParamBindingHolder {

    private ViewModelBundleParamBindingArrayCharSequenceHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelBundleParamBindingArrayCharSequenceHolder> {
        public CreationHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
            super(annotationEnv, element, isSupportV4, isAndroidX);
        }

        public ViewModelBundleParamBindingArrayCharSequenceHolder getHolder() {
            return new ViewModelBundleParamBindingArrayCharSequenceHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
