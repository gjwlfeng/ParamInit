...
public class BundleParamBindingSerializableHolder extends FragmentBundleParamBindingHolder {

    private BundleParamBindingSerializableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends FragmentCreationHolder<BundleParamBindingSerializableHolder> {
        ...
        public BundleParamBindingSerializableHolder getHolder() {

//            TypeMirror typeMirror = element.asType();
//            DeclaredType declaredType= (DeclaredType) typeMirror;
//            Name simpleName = declaredType.asElement().getSimpleName();

            return new BundleParamBindingSerializableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
