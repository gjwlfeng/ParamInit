...
public class ViewModelIntentParamBindingArrayListParcelableHolder extends ViewModelIntentParamBindingHolder {

    private ViewModelIntentParamBindingArrayListParcelableHolder(AnnotationEnv annotationEnv, Element element, boolean isSupportV4, boolean isAndroidX) {
    ...
    public static class CreationHolder extends ViewModelCreationHolder<ViewModelIntentParamBindingArrayListParcelableHolder> {
        ...
        public ViewModelIntentParamBindingArrayListParcelableHolder getHolder() {
            return new ViewModelIntentParamBindingArrayListParcelableHolder(this.annotationEnv, this.element, isSupportV4, isAndroidX);
        }
    }
}
